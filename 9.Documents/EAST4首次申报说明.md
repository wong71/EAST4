...
## 2.2. 报送数据维护（2020.4.15)

根据盈丰软件的 “信托公司管理信息” 统，各自分别维护 机构信息表、股东信息表、员工信息表、关联方。
...
根据EAST4 "信托公司管理信息" 的内容，盈丰软件提供这四张表的EXCEL模板，各自维护数据，导入新增及更新各表数据。

 ### 2.2.3. 基于EAST3 数据转换导入

股东信息表、员工信息表 可在AST3 数据的基础上进行维护：
